defmodule CollectorWeb.Router do
  ...
  import CollectorWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {CollectorWeb.LayoutView, :root}
  ...
  scope "/", CollectorWeb do
    ...
    live_session :require_auth, on_mount: [{CollectorWeb.LiveAuth, :require_authenticated_user}] do
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: CollectorWeb.Telemetry
    end
  end
